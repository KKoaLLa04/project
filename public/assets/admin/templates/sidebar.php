             ...
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                -->
                 ...
                 <!-- 
                    check duyệt - begin 
                -->
                 <li class="nav-item has-treeview <?php echo (activeMenuSidebar('check_course')) ? 'menu-open' : false ?>">
                     <a href="#" class="nav-link <?php echo (activeMenuSidebar('check_course')) ? 'active' : false ?>">
                         <i class="nav-icon fa fa-drafting-compass"></i>
                         <p>
                             Duyệt bài giảng
                             <span class="badge badge-danger"><?php echo !empty($countLesson) ? $countLesson : 0 ?></span>
                             <i class="fas fa-angle-left right"></i>
                         </p>
                     </a>
                     <ul class="nav nav-treeview">
                ...
                -->
                     <li class="nav-item has-treeview <?php echo (activeMenuSidebar('contact')) ? 'menu-open' : false ?>">
                         <a href="#" class="nav-link <?php echo (activeMenuSidebar('contact')) ? 'active' : false ?>">
                             ...
                             <p>
                                 Quản lý liên hệ
                                 <span class="badge badge-danger"><?php echo !empty($countContact) ? $countContact : 0 ?></span>
                                 <i class="fas fa-angle-left right"></i>
                             </p>
                         </a>
                         <ul class="nav nav-treeview">
                ...
                -->
                 <li class="nav-item">
                     <a href="?module=bill&action=lists" class="nav-link <?php echo (activeMenuSidebar('bill')) ? 'active' : false ?>">
                         <i class="nav-icon fa fa-tachometer-alt"></i>
                         <p>
                             Quản lý hóa đơn
                         </p>
